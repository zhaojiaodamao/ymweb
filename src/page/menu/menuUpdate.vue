        ...
        <div class="myborder">
            ...
            <div>
                ...
                <el-row  type="flex"  align="middle" class="row_margin">
                    ...
                    <el-col :span="5">
                        <el-input placeholder="菜单名称或按钮名称" > </el-input>
                    </el-col>
                </el-row>
                <el-row  type="flex"  align="middle" class="row_margin">
                    <el-col :span="3" :offset="3">
                ...
                <div v-show="showurl">
                    <el-row  type="flex"  align="middle" class="row_margin">
                        ...
                        <el-col :span="5">
                            <el-input placeholder="菜单URL"> </el-input>
                        </el-col>
                    </el-row>
                </div>  
                <div v-show="showpre">
                    <el-row  type="flex"  align="middle" class="row_margin">
                        ...
                        <el-col :span="5">
                            <el-input placeholder="多个逗号分隔,如:user:list,user:create"> </el-input>
                        </el-col>
                    </el-row>
                </div>
                ...
                <div v-show="showicon">
                    <el-row  type="flex"  align="middle" class="row_margin">
                        ...
                        <el-col :span="5">
                            <el-input placeholder="菜单图标"> </el-input>
                        </el-col>
                    </el-row>
                </div>
